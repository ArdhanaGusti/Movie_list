...
class MovieDetailPage extends StatefulWidget {
  static const ROUTE_NAME = '/detail_mov';
...
class _MovieDetailPageState extends State<MovieDetailPage> {
  ...
  void initState() {
    super.initState();
    Future.microtask(() {
      Provider.of<MovieBlocDetail>(context, listen: false)
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: BlocConsumer<MovieBlocDetail, DetailState>(
        listener: (context, state) async {
          if (state.watchlistMessage ==
                  MovieBlocDetail.watchlistAddSuccessMessage ||
              state.watchlistMessage ==
                  MovieBlocDetail.watchlistRemoveSuccessMessage) {
...
class DetailContentMov extends StatelessWidget {
  ...
  DetailContentMov(this.movie, this.recommendations, this.isAddedWatchlist);
